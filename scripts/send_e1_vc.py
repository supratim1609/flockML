...
def main():
    ...
    email_target = "deals@e1.vc"
    firm = "E1 Ventures"
    hook = "E1 Ventures' investment thesis on deeptech, frontier computing, and next-gen AI infrastructure"

    body = f"""Hi E1 Ventures Investment Team,
...
I have attached our Seed Investment Presentation (PDF). I would welcome 10 minutes with the E1 Ventures team this week to share our live benchmarks and technical blueprint.
...
"""
    ...
    print(f"Sending pitch to E1 Ventures ({email_target})...")
    server.send_message(msg)
    print(f"  ✓ Successfully sent to {email_target}")
    server.quit()
